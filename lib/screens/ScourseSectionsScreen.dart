import 'package:qr_code_scanner_example/screens/SAttendanceReport.dart';
...
import 'dart:convert';
class ScourseSectionsScreen extends StatefulWidget {

  _ScourseSectionsScreenState createState() => _ScourseSectionsScreenState();
}

class _ScourseSectionsScreenState extends State<ScourseSectionsScreen> {
  List<Courses> course = [];
            ...
            TextButton.icon(
                ...
                onPressed: () {
                  var route = new MaterialPageRoute(
                    builder: (BuildContext context) => new SAttendanceReport(ccourse.SectionID),
                  );
