...
import 'package:qr_code_scanner_example/screens/SectionAttendanceReportScreen.dart';
...
import 'dart:convert';
class SectionLecScreen extends StatefulWidget {
final String sectionid;
SectionLecScreen(this.sectionid);
  _SectionLecScreenState createState() => _SectionLecScreenState();
}

class _SectionLecScreenState extends State<SectionLecScreen> {
  List<Studentlec> slec = [];
  Future<List<Studentlec>> fStudentlec;
  var baseUrl = serverUrl + 'Eattendance/Doctor/Sectionlec.php';
  var isLoading = false;
   _fetchData() async {
    setState(() {
      isLoading = true;
            ...
            TextButton.icon(
                ...
                onPressed: () {
                  var route = new MaterialPageRoute(
                    builder: (BuildContext context) => new SectionAttendanceReportScreen(clec.SectionLecID),
                  );
